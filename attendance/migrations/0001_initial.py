    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bed_number', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='attendance.bed')),
                ('class_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='attendance.class')),
                ('dorm_number', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='attendance.dorm')),
                ('flag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='attendance.flag')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='attendance.action')),
